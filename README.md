...
*   **Search**: Built-in support for **Google**, **Bing**, **Baidu**, **DuckDuckGo**, **Yandex**, and **Brave**. Also supports custom search engines.
*   **Wallpaper**: Support for uploading local images or using **Bing Daily Wallpaper**.
*   **Privacy**: All settings and preferences are stored locally. No tracking.
